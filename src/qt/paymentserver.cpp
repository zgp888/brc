...
const QString BITCOIN_IPC_PREFIX("Billionrichercoin:");
...
{
    QString name("BillionrichercoinQt");
...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click Billionrichercoin: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start Billionrichercoin: click-to-pay handler");
    else
...
{
    // clicking on Billionrichercoin: URLs creates FileOpen events on the Mac:
