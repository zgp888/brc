...
public:
    ...
    {
        // Billionrichercoin: the coin stake transaction is marked with the first output empty
...
public:
    ...
    // Billionrichercoin: block signature - signed by one of the coin base txout[N]'s owner
    ...
    // Billionrichercoin: two types of block: proof-of-work or proof-of-stake
    ...
    // Billionrichercoin: get max transaction timestamp
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    uint256 nChainTrust; // Billionrichercoin: trust score of block chain
    int nHeight;

    int64_t nMint;
    int64_t nMoneySupply;

    unsigned int nFlags;  // Billionrichercoin: block index flags
    enum  
    {
